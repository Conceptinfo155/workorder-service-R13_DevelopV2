...
public class UpdateWorkOrderContractTest extends BaseServiceTest {
	...
	public void updateSuccessResponse() throws Exception {
		...
		mocoServer.request(by(uri("/OMS/workorders/11111134530")))
				.response(contentFromFile(CONTRACT_TEST_DIR, "updateWorkWfxResponse.json"));
	...
	public void test404Error() throws Exception {
		...
		running(mocoServer,
				() -> given().header("Authorization", "Bearer " + OAuthTokenHelper.getToken())
						...
						.accept("application/json").post("/workorder/v1/updateworkorder1/ORION-11111103700000051")
