...
@Component
public class ErrorHandlingActivator {
	private final Logger log = LoggerFactory.getLogger(this.getClass());



	@ServiceActivator(inputChannel = "errorChannel", outputChannel="aggregatorWorkorderChannel")
	public Object errorHandler(Message message)
		...
		org.springframework.messaging.MessageHandlingException ex = (MessageHandlingException) message.getPayload();
