...
public class Service {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(action).append(serviceId).append(armObjectName).append(serviceType).append(name).append(characteristics).append(dependentServices).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(action, rhs.action).append(serviceId, rhs.serviceId).append(armObjectName, rhs.armObjectName).append(serviceType, rhs.serviceType).append(name, rhs.name).append(characteristics, rhs.characteristics).append(dependentServices, rhs.dependentServices).isEquals();
    }
