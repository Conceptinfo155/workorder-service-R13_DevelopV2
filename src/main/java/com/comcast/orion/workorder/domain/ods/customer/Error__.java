...
public class Error__ {
    ...
    public Error__ withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public Error__ withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Error__) == false) {
            return false;
        }
        Error__ rhs = ((Error__) other);
