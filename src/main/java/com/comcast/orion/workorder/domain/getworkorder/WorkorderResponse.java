...
public class WorkorderResponse {
    ...
    public WorkorderResponse withWorkOrderDetails(WorkOrderDetails workOrderDetails) {
        this.workOrderDetails = workOrderDetails;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WorkorderResponse) == false) {
            return false;
        }
        WorkorderResponse rhs = ((WorkorderResponse) other);
