...
public class Error {
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 0, value = "", example = "CONTRACT_VOILATION")
    private String code;
    @JsonProperty("message")
    @JsonPropertyDescription("")
    @ApiModelProperty(required = false, dataType = "string", position = 0, value = "", example = "<Field Name> - Mandatory Field is missing in the request")
