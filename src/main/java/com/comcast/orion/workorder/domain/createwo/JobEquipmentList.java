...
public class JobEquipmentList {
    ...
    @ApiModelProperty(required = true, dataType = "string", position = 0, value = "Serial Number passed by Amdocs - WFX", example = "3434")
    @Size(min = 1, max = 25)
    ...
    @ApiModelProperty(required = true, dataType = "string", position = 0, value = "Equipment Type Code passed by Amdocs - WFX", example = "HFC24")
    @Size(min = 1, max = 5)
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 0, value = "Equipment Status Code passed by Amdocs - WFX", example = "N")
    @Size(min = 0, max = 1)
    ...
    @ApiModelProperty(required = true, dataType = "string", position = 0, value = "Owner Code passed by Amdocs - WFX", example = "P")
    private JobEquipmentList.OwnerCd ownerCd;
    /**
     * Owner Code passed by Amdocs - WFX
     * (Required)
     * 
    ...
    @JsonPropertyDescription("Owner Code passed by Amdocs - WFX")
    @ApiModelProperty(required = true, dataType = "string", position = 0, value = "Owner Code passed by Amdocs - WFX", example = "ADD")
    private JobEquipmentList.ActionCd actionCd;
    /**
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 0, value = "Equipment Make passed by Amdocs - WFX", example = "equipMake")
    @Size(min = 0, max = 25)
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 0, value = "Equipment Model Code by Amdocs - WFX", example = "equipModelCd")
    @Size(min = 0, max = 30)
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 0, value = "Device Address passed by Amdocs - WFX", example = "deviceAddress")
    @Size(min = 0, max = 20)
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 0, value = "Device Address2 passed by Amdocs - WFX", example = "deviceAddress2")
    @Size(min = 0, max = 20)
     ...
     */
    @JsonProperty("ownerCd")
    public JobEquipmentList.OwnerCd getOwnerCd() {
        return ownerCd;
    }
     ...
     */
    @JsonProperty("ownerCd")
    public void setOwnerCd(JobEquipmentList.OwnerCd ownerCd) {
        this.ownerCd = ownerCd;
    }

    public JobEquipmentList withOwnerCd(JobEquipmentList.OwnerCd ownerCd) {
        this.ownerCd = ownerCd;
        return this;
    }
     ...
     */
    @JsonProperty("actionCd")
    public JobEquipmentList.ActionCd getActionCd() {
        return actionCd;
    }
     ...
     */
    @JsonProperty("actionCd")
    public void setActionCd(JobEquipmentList.ActionCd actionCd) {
        this.actionCd = actionCd;
    }

    public JobEquipmentList withActionCd(JobEquipmentList.ActionCd actionCd) {
        this.actionCd = actionCd;
        return this;
    }
    ...
    public enum ActionCd {
        ...
        private final static Map<String, JobEquipmentList.ActionCd> CONSTANTS = new HashMap<String, JobEquipmentList.ActionCd>();

        static {
            for (JobEquipmentList.ActionCd c: values()) {
        ...
        @JsonCreator
        public static JobEquipmentList.ActionCd fromValue(String value) {
            JobEquipmentList.ActionCd constant = CONSTANTS.get(value);
            if (constant == null) {
    ...
    public enum OwnerCd {
        ...
        R("R");
        private final String value;
        private final static Map<String, JobEquipmentList.OwnerCd> CONSTANTS = new HashMap<String, JobEquipmentList.OwnerCd>();

        static {
            for (JobEquipmentList.OwnerCd c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        private OwnerCd(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static JobEquipmentList.OwnerCd fromValue(String value) {
            JobEquipmentList.OwnerCd constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
