...
public class Equipment {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(action).append(serviceId).append(armObjectName).append(equipmentType).append(services).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(action, rhs.action).append(serviceId, rhs.serviceId).append(armObjectName, rhs.armObjectName).append(equipmentType, rhs.equipmentType).append(services, rhs.services).isEquals();
    }
