...
public class SolutionDetail {
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 0, value = "", example = "BVE-COAX/BVE-OTT")
...
//THis enum is not required as per requirement, order type can be case insensitive from the request
