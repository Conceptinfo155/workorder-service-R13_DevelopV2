...
public class GetWorkorderOMWResponse {
    ...
    public GetWorkorderOMWResponse withWorkOrder(WorkOrder workOrder) {
        this.workOrder = workOrder;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetWorkorderOMWResponse) == false) {
            return false;
        }
        GetWorkorderOMWResponse rhs = ((GetWorkorderOMWResponse) other);
