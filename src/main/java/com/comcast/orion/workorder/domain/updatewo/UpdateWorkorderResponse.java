...
public class UpdateWorkorderResponse {
    ...
    public UpdateWorkorderResponse withWorkOrderNum(String workOrderNum) {
        this.workOrderNum = workOrderNum;
        return this;
    }
    ...
    public UpdateWorkorderResponse withResponse(String response) {
        this.response = response;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdateWorkorderResponse) == false) {
            return false;
        }
        UpdateWorkorderResponse rhs = ((UpdateWorkorderResponse) other);
