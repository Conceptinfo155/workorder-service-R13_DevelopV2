...
public class JobCustomer {
    ...
    @ApiModelProperty(required = true, dataType = "string", position = 1, value = "Amdocs CustomerId passed by Amdocs - WFX", example = "30370000001")
    @Size(min = 1, max = 25)
    ...
    @ApiModelProperty(required = true, dataType = "string", position = 0, value = "Site Id passed by Amdocs - WFX", example = "8562631979")
    @Size(min = 1, max = 20)
    ...
    @ApiModelProperty(required = true, dataType = "string", position = 2, value = "Amdocs LastName passed by Amdocs - WFX", example = "TR")
    @Size(min = 1, max = 50)
    ...
    /**
     * Amdocs SiteSignageName passed by Amdocs - WFX
     * 
     */
    @JsonProperty("siteSignageName")
    @JsonPropertyDescription("Amdocs SiteSignageName passed by Amdocs - WFX")
    @ApiModelProperty(required = false, dataType = "string", position = 7, value = "Amdocs SiteSignageName passed by Amdocs - WFX", example = "site signage name")
    @Size(min = 0, max = 80)
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(customerId, rhs.customerId).append(siteId, rhs.siteId).append(lastName, rhs.lastName).append(firstName, rhs.firstName).append(homePhoneNum, rhs.homePhoneNum).append(workPhoneNum, rhs.workPhoneNum).append(emailAddr, rhs.emailAddr).append(siteSignageName, rhs.siteSignageName).isEquals();
    }
