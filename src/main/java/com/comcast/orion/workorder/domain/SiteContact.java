...
public class SiteContact {
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 6, value = "Title for individuals name. Eg. Mr. Dr. etc", example = "Mr")
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 7, value = "The Role of the user. If Primary user - It would have value as Primary. ", example = "Primary")
    private String role;
    /**
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 8, value = "The preferred contact method of the individual - Email, Phone, Fax, Postal", example = "Email")
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 9, value = "The preferred contact period of the individual - For Example: Morning, Afternoon, Evening, Midday", example = "Morning")
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 10, value = "The preferred contact time of the individual - Morning, Evening, Afternoon", example = "Morning")
    ...
    @ApiModelProperty(required = false, dataType = "string", position = 11, value = "The preferred Language for the contact", example = "English (United States)")
    ...
    public SiteContact withContactId(String contactId) {
        this.contactId = contactId;
        return this;
    }
    ...
    public SiteContact withMiddleName(String middleName) {
        this.middleName = middleName;
        return this;
    }
    ...
    public SiteContact withDisplayName(String displayName) {
        this.displayName = displayName;
        return this;
    }
    ...
    public SiteContact withRole(String role) {
        this.role = role;
        return this;
    }
    ...
    public SiteContact withPreferredContactMethod(String preferredContactMethod) {
        this.preferredContactMethod = preferredContactMethod;
        return this;
    }
    ...
    public SiteContact withPreferredContactPeriod(String preferredContactPeriod) {
        this.preferredContactPeriod = preferredContactPeriod;
        return this;
    }
    ...
    public SiteContact withPreferredContactTime(String preferredContactTime) {
        this.preferredContactTime = preferredContactTime;
        return this;
    }
    ...
    public SiteContact withPreferredLanguage(String preferredLanguage) {
        this.preferredLanguage = preferredLanguage;
        return this;
    }
    ...
    public SiteContact withContactMethods(List<ContactMethod> contactMethods) {
        this.contactMethods = contactMethods;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(contactId).append(firstName).append(lastName).append(middleName).append(displayName).append(title).append(role).append(preferredContactMethod).append(preferredContactPeriod).append(preferredContactTime).append(preferredLanguage).append(contactMethods).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SiteContact) == false) {
            return false;
        }
        SiteContact rhs = ((SiteContact) other);
        return new EqualsBuilder().append(contactId, rhs.contactId).append(firstName, rhs.firstName).append(lastName, rhs.lastName).append(middleName, rhs.middleName).append(displayName, rhs.displayName).append(title, rhs.title).append(role, rhs.role).append(preferredContactMethod, rhs.preferredContactMethod).append(preferredContactPeriod, rhs.preferredContactPeriod).append(preferredContactTime, rhs.preferredContactTime).append(preferredLanguage, rhs.preferredLanguage).append(contactMethods, rhs.contactMethods).isEquals();
    }
