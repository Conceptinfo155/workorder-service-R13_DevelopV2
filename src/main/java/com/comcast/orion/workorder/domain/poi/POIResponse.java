...
public class POIResponse {
    ...
    public POIResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public POIResponse withErrors(List<Error> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof POIResponse) == false) {
            return false;
        }
        POIResponse rhs = ((POIResponse) other);
