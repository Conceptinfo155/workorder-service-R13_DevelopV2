...
public class CancelAppointmentResponse {
    ...
    public CancelAppointmentResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CancelAppointmentResponse withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public CancelAppointmentResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CancelAppointmentResponse) == false) {
            return false;
        }
        CancelAppointmentResponse rhs = ((CancelAppointmentResponse) other);
