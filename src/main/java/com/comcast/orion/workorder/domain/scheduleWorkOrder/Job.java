...
public class Job {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(scheduleDate).append(timeSlotCd).append(callFirstPhoneNum).append(troubleCallIndicator).append(jobComment).append(orderComment).append(jobReasonCode).append(technicianNum).toHashCode();
    }
